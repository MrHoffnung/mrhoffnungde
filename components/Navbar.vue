<template>
  <div class="relative bg-purple-50 text-gray-900">
    <div
      class="relative flex w-screen max-w-screen-xl flex-col overflow-hidden px-4 py-4 md:mx-auto md:flex-row md:items-center"
      id="top">
      <NuxtLink to="/"
        class="flex cursor-pointer items-center whitespace-nowrap text-2xl font-black uppercase text-transparent bg-gradient-to-tr bg-clip-text from-violet-400 to-violet-900 lg:hover:scale-110 transition">
        MrHoffnung
      </NuxtLink>
      ...
      <nav aria-label="Header Navigation"
        ...
        <ul class="flex flex-col items-center space-y-2 md:ml-auto md:flex-row md:space-y-0">
          ...
          <li class="md:mr-12">
            <NuxtLink to="#daytistics">Daytistics</NuxtLink>
          </li>
          <li class="md:mr-12">
